...
<div id="slideShow" class="slideshow-container">
    ...
    A database paying tribute to the musicians and the venues of the Eastern Shore.</div>
    </div>
...
<hr>
<p  style="color:white; font-size: 25px; font-family: Verdana; ">Look through the Eastern Shore Groove Database with the search feature. The user will be able to serch for a certain artist and their data based on attributes. The user will be able to search for not only Bands, but the different performances and venues across the Eastern Shore as well.  </p>
</div>
</div>
