...
<legend id="loginLegend"  style="font-size: 20pt">Update Table</legend>


<label for="Table" id="textLabel" >Choose a Table:</label>



<select name="table" id="userName" onchange="javascript:location.href = this.value;">
	...
	<option value="updatePerformances.php">Performances</option>
  	...
  	<option value="updateMerch.php">Merch</option>
  	<option value="updateTravelto.php">Travelto</option>
